...
class MovieRecommendationSystem:
    ...
    def get_content_recommendations(self, title, num_recommendations=10):
        ...
        try:
            ...
            return self.data.iloc[movie_indices][['title', 'vote_average', 'genres', 'release_date']]
        except:
            return None
    ...
    def get_gemini_recommendations(self, movie_title, num_recommendations=5):
        ...
        try:
            ...
            Movie Title: Brief reasoning (1-2 sentences)
            
            Focus on thematic similarities, directorial style, actor performances, and genre elements.
            """
    ...
    def get_movie_poster(self, movie_title):
        """Fetch movie poster from TMDB API (placeholder - implement with actual API key)"""
        # This is a placeholder - you'll need to sign up for TMDB API and get an API key
        return "https://via.placeholder.com/300x450/667eea/ffffff?text=Poster+Not+Available"
    ...
    def create_visualizations(self):
        ...
        with viz_tab2:
            ...
            with col2:
                ...
                genre_combinations = self.data['genres'].value_counts().head(10)
                fig = px.pie(
                    values=genre_combinations.values,
                    names=genre_combinations.index,
...
def main():
        ...
        with col1:
            ...
            if selected_movie:
                ...
                <div class="movie-card">
                    ...
                    <p><strong>⭐ Rating:</strong> {movie_info['vote_average']}/10</p>
        ...
        if not gemini_api_key:
            ...
            with col1:
                selected_genres = st.multiselect(
                    "Filter by genres:",
                    options=list(set([genre for genres in recommender.data['genres'] 
            ...
            with col2:
                selected_director = st.selectbox(
                    "Filter by director:",
                    options=["All"] + sorted(recommender.data['director'].unique().tolist())
                )
            ...
            if len(filtered_data) > 0:
                ...
                for idx, (_, movie) in enumerate(filtered_data.head(9).iterrows()):
    ...
    with tab3:
        ...
        with col1:
            ...
            director_stats.columns = ['Avg Rating', 'Movie Count', 'Avg Revenue']
